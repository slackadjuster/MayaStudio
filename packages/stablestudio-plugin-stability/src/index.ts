...
const HARDCODED_API_KEY = "sk-2DamiNoJZDGhWLNot11y3udXZfLsFg7fgVvWrDqLu5jTzuH8";
  ...
  return {
    ...
    settings: {
      apiKey: {
        ...
        title: "API key",
        description:
          "You can find your OpenMaya API key in your invitation email.",

        placeholder: "sk-...",
        required: true,
        password: true,

        value: localStorage.getItem("stability-apiKey") ?? HARDCODED_API_KEY,
      },
    },
